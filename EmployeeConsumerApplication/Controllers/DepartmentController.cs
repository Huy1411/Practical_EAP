    ...
    public class DepartmentController : Controller
    {
        ...
        public ViewResult Index(string sortOrder, string search, string currentFilter, int? page)
        {
            ...
            */
            ...
            var departments = from s in servicesClient.getAllDeparment() select s;
        ...
        {
            var department = servicesClient.getAllDeparment().Where(b => b.DepartmentID == id).FirstOrDefault();
